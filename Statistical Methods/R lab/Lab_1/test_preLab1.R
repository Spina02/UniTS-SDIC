...
par(mfrow = c(1,2))
hist(X[,1], prob = TRUE, breaks = 30, cex.lab = 1)
curve(dnorm(x, mu_h, sd_h), col = "red", add=TRUE)
hist(X[,2], prob = TRUE, breaks = 30, cex.lab = 1)
...
curve(dnorm(x, muw_c, sdw_c), from = 50, to = 130, 
      cex.lab = 1, cex.axis = 1, xlab = "x2")
curve(dnorm(x, muh_c, sdh_c), from = 140, to = 200, 
      cex.lab = 1, cex.axis = 1, xlab = "x1")
...
plot(X[,1], X[,2], xlab = "x1", ylab = "x2", cex.axis = 1, cex.lab = 1)
